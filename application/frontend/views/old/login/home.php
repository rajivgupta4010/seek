  ...
  <div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal fade in" id="myModal" style="display: block;">
    <div class="modal-dialog l-row3s">
      <div class="modal-content">
          <a class="reg_close_btn_rs" href="<?php echo site_url('home/index');?>"><button data-dismiss="modal" class="close" type="button"><span aria-hidden="true"><img src="<?php echo base_url();?>assets/images/close_icon.png" alt="close_icon"></span><span class="sr-only">Close</span></button></a>
