								...
								<tr>
									<td>
										 <?php echo $count;?>
                                                                            ...
                                                                            <a href="<?php echo site_url('classifications/sub_classification/'.$item->id)?>"><?php echo $item->name;?></a>
									</td>
									...
									<td>
											 ...
											 Unpublish
                                                                        ...
                                                                        <td>
                                                                            <a href='<?php echo current_url()."/edit_item/{$item->id}";?>' class="btn default btn-xs purple">
