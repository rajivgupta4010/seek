...
class Adaptive_payments extends CI_Controller 
{
	...
	function Pay()
	{
		...
		$PayRequestFields = array(
								...
								'CancelURL' => 'http://www.google.com/cancle', 									// Required.  The URL to which the sender's browser is redirected if the sender cancels the approval for the payment after logging in to paypal.com.  1024 char max.
								...
								'Memo' => 'Hiiiii test job', 										// A note associated with the payment (text, not HTML).  1000 char max
								'Pin' => '', 										// The sener's personal id number, which was specified when the sender signed up for the preapproval
								'PreapprovalKey' => '', 							// The key associated with a preapproval for this payment.  The preapproval is required if this is a preapproved payment.  
								'ReturnURL' => 'http://www.google.com/creturn', 									// Required.  The URL to which the sener's browser is redirected after approvaing a payment on paypal.com.  1024 char max.
								'ReverseAllParallelPaymentsOnError' => '', 			// Whether to reverse paralel payments if an error occurs with a payment.  Values are:  TRUE, FALSE
								'SenderEmail' => 'testing.seek@gmail.com', 								// Sender's email address.  127 char max.
		...
		$Receivers = array();
		$Receiver = array(
						'Amount' => '7888', 											// Required.  Amount to be paid to the receiver.
						'Email' => 'testing.seek.merchant@slinfy.com', 												// Receiver's email address. 127 char max.
						'InvoiceID' => 'INhun546', 											// The invoice number for the payment.  127 char max.
	...
	function Pay_with_options()
	{
		// Pay
		$PayRequestFields = array(
				'CancelURL' => 'www.google.com', 									// Required.  The URL to which the sender's browser is redirected if the sender cancels the approval for the payment after logging in to paypal.com.  1024 char max.
				...
				'IPNNotificationURL' => 'http://112.196.33.85/solitaire/demo/seek/paypal', 						// The URL to which you want all IPN messages for this payment to be sent.  1024 char max.
				'Memo' => 'dfdfdfdffdfd', 										// A note associated with the payment (text, not HTML).  1000 char max
				'Pin' => '7878787', 										// The sener's personal id number, which was specified when the sender signed up for the preapproval
				'PreapprovalKey' => '', 							// The key associated with a preapproval for this payment.  The preapproval is required if this is a preapproved payment.
				'ReturnURL' => 'www.hrl.com', 									// Required.  The URL to which the sener's browser is redirected after approvaing a payment on paypal.com.  1024 char max.
				'ReverseAllParallelPaymentsOnError' => '', 			// Whether to reverse paralel payments if an error occurs with a payment.  Values are:  TRUE, FALSE
				'SenderEmail' => 'testing.seek@gmail.com', 								// Sender's email address.  127 char max.
				'TrackingID' => ''									// Unique ID that you specify to track the payment.  127 char max.
		);
		...
		$Receivers = array();
		$Receiver = array(
				'Amount' => '8999', 											// Required.  Amount to be paid to the receiver.
	...
	function Create_invoice()
	{
		...
		$CreateInvoiceFields = array(
									'MerchantEmail' => 'testing.seek.merchant@slinfy.com', 				// Required.  Merchant email address.
									'PayerEmail' => 'testing.seek@gmail.com', 				// Required.  Payer email address.
									'Number' => 'CDR8965', 					// Unique ID for the invoice.
									'CurrencyCode' => 'USD', 				// Required.  Currency used for all invoice item amounts and totals.
									'InvoiceDate' => '7/10/2014', 				// Date on which the invoice is enabled.
									'DueDate' => '15/7/2014', 					// Date on which the invoice payment is due.
									...
									'DiscountPercent' => '10', 			// Discount percent applied to the invoice.
									...
									'Note' => 'fstgdfgdgfgdf', 						// Note to the payer company.
	...
	{
		$InvoiceID = 'KJHfdfH8d78787'; // Required.  Invoice ID of the invoice to send.
	...
	function Create_and_send_invoice()
	{
		...
		$CreateInvoiceFields = array(
									'MerchantEmail' => 'testing.seek.merchant@slinfy.com', 				// Required.  Merchant email address.
									'PayerEmail' => 'rajivgupta.php@slinfy.com', 				// Required.  Payer email address.
									'Number' => 'INC262622626', 					// Unique ID for the invoice.
									'CurrencyCode' => 'USD', 				// Required.  Currency used for all invoice item amounts and totals.
									'InvoiceDate' => '2014-06-26Z', 				// Date on which the invoice is enabled.
									'DueDate' => '2014-10-26Z',   //YYYY-MM-DD					// Date on which the invoice payment is due.
									'PaymentTerms' => 'DueOnReceipt', 				// Required.  Terms by which the invoice payment is due.  Values are:  DueOnReceipt, DueOnSpecified, Net10, Net15, Net30, Net45
									'DiscountPercent' => '10', 			// Discount percent applied to the invoice.
									'DiscountAmount' => '25', 			// Discount amount applied to the invoice.  If DiscountPercent is provided, DiscountAmount is ignored.
									'Terms' => '', 						// General terms for the invoice.
		...
		$BusinessInfo = array(
							'FirstName' => 'Rajiv', 							// First name of the company contact.
							'LastName' => 'Gupta', 							// Last name of the company contact.
							'BusinessName' => 'Sochtek', 						// Company business name.
							'Phone' => '9815351200', 								// Phone number for contacting the company.
							'Fax' => 'dffdfdfdf', 								// Fax number used by the company.
							'Website' => '', 							// Website used by the company.
							'Custom' => '' 										// Custom value to be displayed in the contact information details.
							);
							
		$BusinessInfoAddress = array(
									'Line1' => 'India', 						// Required. First line of address.
									'Line2' => '', 						// Second line of address.
									'City' => '', 						// Required. City of thte address.
									'State' => '', 						// State for the address.
									'PostalCode' => '', 				// Postal code of the address
									'CountryCode' => 'IN'					// Required.  Country code of the address.
									);
		...
		$BillingInfoAddress = array(
								'Line1' => 'INDia', 						// Required. First line of address.
								'Line2' => 'sdsd', 						// Second line of address.
								'City' => 'sdsd', 						// Required. City of thte address.
								'State' => 'sadsad', 						// State for the address.
								'PostalCode' => '147001', 				// Postal code of the address
								'CountryCode' => 'IN'					// Required.  Country code of the address.
								);
		...
		$InvoiceItem = array(
							'Name' => 'SKU87452', 							// Required.  SKU or name of the item.
							'Description' => 'HI', 					// Item description.
							'Date' => '2010-09-10Z', 							// Date on which the product or service was provided.
							'Quantity' => '2', 						// Required.  Item count.  Values are:  0 to 10000
							'UnitPrice' => '2', 						// Required.  Price of the item, in the currency specified by the invoice.
							'TaxName' => '', 						// Name of the applicable tax.
							'TaxRate' => ''							// Rate of the applicable tax.
							);
		array_push($InvoiceItems,$InvoiceItem);
		...
		{
			echo " Successful call.  Load view or whatever you need to do here.	";
		}	
	}
