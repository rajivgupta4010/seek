...
$config['APIUsername'] = $config['Sandbox'] ? 'testing.seek.merchant_api1.slinfy.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '6GGMZD8QA8HD8PMQ' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AgmlStGMk8KCvIExhEWpl9nb2lZSA9ejsJUYedoWhEljlGQy.me5vPAM' : 'PRODUCTION_SIGNATURE_GOES_HERE';
