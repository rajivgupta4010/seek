<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName="testing.slinfy02_api1.gmail.com";
	$API_Password="1373275897";
	$API_Signature="AoNBG1CBIgLS5QaKlVpODjsaTncPABthzh5N-Nzz5tOodumbgF0TvVDq";
	...
	*/
	function CallShortcutExpressCheckout( $paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL) 
	{
		...
		$nvpstr = $nvpstr . "&BILLINGAGREEMENTDESCRIPTION=".urlencode("Recurring Payment($paymentAmount monthly)");
