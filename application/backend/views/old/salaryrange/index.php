					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							...
							<ul class="dropdown-menu pull-right" role="menu">
								<li>
									<a href='<?PHP echo site_url("{$nav}/new_item");?>'>
								...
								<tr>
									<td>
										 <?php echo $count;?>
                                                                            ...
                                                                            <a href='<?php echo site_url("{$nav}/subitems/".$item->id)?>'><?php echo $item->name;?></a>
									</td>
									...
									<td>
											 ...
											 Unpublish
                                                                        ...
                                                                        <td>
                                                                            <a href='<?php echo base_url()."salaryrange/edit_item/{$item->id}";?>' class="btn default btn-xs purple">
