								...
								<tr>
									<td>
										 <?php echo $count;?>
                                                                            ...
                                                                            <a href='<?php echo site_url("{$master_body}/sub_location/".$item->id)?>' > (<?php echo $item->pname;?>) - <?php echo $item->name;?></a>
									</td>
									...
									<td>
											 ...
											 Unpublish
                                                                        ...
                                                                        <td>
                                                                            <a href='<?php echo base_url()."locations/edit_item/{$item->id}";?>' class="btn default btn-xs purple">
