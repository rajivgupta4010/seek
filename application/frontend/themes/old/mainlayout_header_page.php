<nav role="navigation" class="border_inc navbar navbar-fixed-top111 navbar-default" id="topnav">
		<div class="container">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse custom_menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li <?php if($url=='how_this_work'){echo 'class="active"';}?>><a href="<?php echo base_url();?>pages/how_this_work">How This Works</a></li> 
