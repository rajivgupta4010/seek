        ...
        <ul class="page-breadcrumb breadcrumb">
          <li class="btn-group">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
              <li> <a href="<?PHP echo site_url('locations/new_item');?>"> Add New Location </a> </li>
            </ul>
          </li>
      ...
      <div class="col-md-12"> 
        ...
        <div class="portlet box yellow">
          <div class="portlet-title">
            <div class="caption"> <i class="fa fa-coffee"></i>Province
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php   if(($item->status)==1) :  ?>
                      ...
                      <?php endif;?></td>
                    <td><a href="#" class="btn default btn-xs purple"> <i class="fa fa-edit"></i> Edit </a> <a href='<?php echo current_url()."?deleteitem={$item->id}";?>' class="btn default btn-xs black delete_confirm"> <i class="fa fa-trash-o"></i> Delete </a></td>
                  </tr>
                  <?php $count++; ?>
                  <?php endforeach; ?>
                </tbody>
