...
//            'upload_url' => $this->get_full_url() . '/files/',
            ...
            'upload_url' => ROOT_URL . '/upload/photos/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_file_types' => '/\.(gif|jpe?g|png|docx|doc|pdf)$/i',
    ...
    protected function handle_form_data($file, $index) {
        ...
        $file->uploader = @$_REQUEST['uploader'];
        $file->action = @$_REQUEST['action'];
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        ...
        /*
         * UPDATE COVER PHOTO HERE generate thumb for saving  as elecronic passport 
         */
        $isprofilephoto = 1;
        $isactiveprofilephoto = 1;
        $date = date('Y-m-d H:i:s');
        $sql_crop_profileimage = "INSERT into user_photos(uploader_id,phototitle,isprofilephoto,isactiveprofilephoto,createdon) "
                . "values('" . $file->uploader . "','" . $file->name . "','" . $isprofilephoto . "','" . $isactiveprofilephoto . "','" . $date . "')";
        $exec_crop_profileimage = mysql_query($sql_crop_profileimage) or die(mysql_error());
        ...
        if (!empty($profileid)) {
            ...
            $sql_prev_update_profile = "UPDATE user_photos SET isactiveprofilephoto='0' WHERE id !='$profileid' and uploader_id ='" . $file->uploader . "'";
            $exec_prev_update_profile = mysql_query($sql_prev_update_profile);
