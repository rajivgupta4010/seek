        ...
        <ul class="page-breadcrumb breadcrumb">
          <li class="btn-group">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
              <li> <a href='<?PHP echo site_url("{$main_nav}/new_item");?>'> Add New
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php   if(($item->status)==1) :  ?>
                      ...
                      <?php endif;?></td>
                    <td><?php if((int)($item->update_at)) echo $item->update_at;?></td>
                    <td><a href='<?php echo current_url()."/../edit_item/{$item->id}";?>' class="btn default btn-xs purple"> <i class="fa fa-edit"></i> Edit </a> <a href='<?php echo current_url()."?deleteitem={$item->id}";?>' class="btn default btn-xs black delete_confirm"> <i class="fa fa-trash-o"></i> Delete </a></td>
                  </tr>
                  <?php $count++; ?>
                  <?php endforeach; ?>
                </tbody>
